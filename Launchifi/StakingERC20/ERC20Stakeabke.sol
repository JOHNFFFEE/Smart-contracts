...
contract ERC20Stakeable is ERC20, ERC20Burnable, ReentrancyGuard {
    ...
    //Mapping summing all staker earning
    mapping (address=>uint) public totalUserEarning ;
    
    //Total token staked
    uint public numberStaked ;
    ...
    function claimRewards() external nonReentrant {
        ...
        stakers[msg.sender].unclaimedRewards = 0;
        stakers[msg.sender].timeOfLastUpdate = block.timestamp;
        totalUserEarning[msg.sender]+=rewards ;
    ...
    function withdrawAll() external nonReentrant {
        ...
        totalUserEarning[msg.sender]+=_rewards ;
        numberStaked-= _deposit;        
        _mint(msg.sender, _amount);
    }
