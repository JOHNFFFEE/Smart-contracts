interface IERC5643 {
    ...
    event SubscriptionUpdate(uint256 indexed tokenId);
    ...
    function cancelSubscription(uint256 tokenId , address _user) external;
    ...
    function expiresAt(uint256 tokenId, address _user) external view returns(uint64);
